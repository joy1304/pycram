...
#@with_error_handling
def unreachable_object_demo(grasp_data=None, grasp_classifier=None, guardian=None, **_):
    """
    ...
    object_configs = [
        {"name": "red_box", "arm": Arms.RIGHT, "place_offset": 0.5},
        {"name": "blue_box", "arm": Arms.LEFT, "place_offset": 0.5}, # Demonstrates Left Arm usage
        {"name": "green_box", "arm": Arms.RIGHT, "place_offset": 0.5},
    ]
...
if __name__ == '__main__':
    ...
    with simulated_robot:
        try:
            unreachable_object_demo(grasp_data=grasp_data)
